...
import { isLocal } from '../../video/source_select';
export default (
    <div>
            ...
            <>
                <details>
                    ...
                    <ol type="1">
                        ...
                        <li>
                            In the source selection menu on the left side of the
                            screen, select the leftmost icon that looks like a
                            smartphone.
                        </li>
                        <li>
                            Ensure your smartphone and computer are connected to
                            the same local network (Both are using Wi-Fi with
                            the same name).
                        </li>
                        <li>
                            Input the IP and Port displayed on the screen in the
                            DroidCam app into Spectrala under the source select
                            buttons.
                        </li>
                    </ol>
                </details>
                <details>
                    ...
                    <ol type="1">
                        <li>
                            In the source selection menu on the left side of the
                            screen, select the icon second to the left that
                            looks like a broadcast pin.
                        </li>
                        <li>
                            Ensure your camera stream and computer are connected
                            to the same local network.
                        </li>
                        <li>
                            Input the stream URL into Spectrala under the source
                            select buttons.
                        </li>
                    </ol>
                </details>
